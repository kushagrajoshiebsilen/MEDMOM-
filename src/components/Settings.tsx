      ...
      <section className="bg-white rounded-[3rem] p-8 shadow-ambient border border-outline/5 space-y-8">
        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          >
            ...
            <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${settings.alertPreference === 'notification' ? 'bg-primary border-primary' : 'border-outline/20'}`}>
